  ...
  useEffect(() => {
    if (initialData) {
      setFormData({
        ...
        sa_id_number: initialData.sa_id_number || "",
        ...
        medical_aid_provider: initialData.medical_aid_provider || "",
        medical_aid_number: initialData.medical_aid_number || "",
        medical_aid_plan: initialData.medical_aid_plan || "",
        allergies: Array.isArray(initialData.allergies) ? initialData.allergies.join(", ") : "",
        conditions: Array.isArray(initialData.conditions) ? initialData.conditions.join(", ") : "",
        notes: initialData.notes || "",
        consent_signed: initialData.consent_signed || false
      });
    }
  }, [initialData]);
