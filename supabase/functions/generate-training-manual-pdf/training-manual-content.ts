// Training manual content embedded for edge function access
// This file contains the full markdown content of all training manuals

export const trainingManualContent: Record<string, string> = {
  control_room: `# Training Manual - Control Room Operator
