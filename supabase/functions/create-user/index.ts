        ...
        if (settings?.zapier_webhook_url) {
          ...
          await supabaseAdmin.functions.invoke('trigger-notification', {
            body: {
              ...
              subject: 'Welcome to Hospital at Home',
              message: `Welcome ${full_name}! Your account has been created.`,
              recipientEmail: email,
              recipientName: full_name,
              additionalData: {
                temporary_password: password,
                role: role,
                login_url: `${Deno.env.get('SUPABASE_URL')?.replace('supabase.co', 'lovableproject.com')}/auth`,
                must_change_password: isAutoGeneratedPassword,
                instructions: 'Please use the temporary password below to log in. You will be required to change your password on first login for security.'
              }
            }
          })
