...
1. Create → 2. Add Medications → 3. Save Draft → 4. Review → 5. Approve & Sign

### Status Indicators
- 📝 **Draft**: Still being prepared
- ⏳ **Pending**: Ready for approval
- ✅ **Approved**: Signed and finalized

### Important Reminders
- ⚠️ Always verify patient allergies
- ⚠️ Check for drug interactions
- ⚠️ Signatures are legally binding
- ⚠️ Cannot edit approved prescriptions
